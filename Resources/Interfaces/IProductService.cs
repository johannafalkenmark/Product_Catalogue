...
public interface IProductService<T, TResult> where T : class where TResult : class 
{
    ...
    public ResponseResult<IEnumerable<TResult>> ShowAllProductsInList(); //Visa alla produkter i listan med ID namn och pris (foreach-loop) - skapa funktionalitet i prodctservice
